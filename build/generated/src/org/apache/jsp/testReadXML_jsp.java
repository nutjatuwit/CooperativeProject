...
public final class testReadXML_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("       ");
         ...
         request.setCharacterEncoding("UTF-8");
            Class.forName("org.postgresql.Driver").newInstance();
              ...
              String sqlDetailCount = "";
              
              while(rsCateCount.next()){
                 out.println(rsCateCount.getString(2)+"<br><br>");
                 sqlDetailCount = "select id_report,name_report from a_report_detail where id_cate = '"+rsCateCount.getString(1)+"' order by id_report ASC";
                 rsDetailCount = statement1.executeQuery(sqlDetailCount);
                 //out.println(sqlDetailCount+"<br>");
                  while(rsDetailCount.next()){
                     out.println(rsDetailCount.getString(2)+"<br>");
                  }
